...
data = pd.read_csv('/home/tiagocardoso/AIEngineer/1.FundAi/Projeto_Pratico/data_sets/HistoricalData_meta.csv')

data['Close/Last'] = data['Close/Last'].str.replace('$', '', regex=False).astype(float) # removendo o símbolo de dólar
data['Date'] = pd.to_datetime(data['Date']) # convertendo a coluna de data para o formato datetime
...
forecast.to_csv(
    '/home/tiagocardoso/AIEngineer/1.FundAi/Projeto_Pratico/data_sets/forecast.csv')
