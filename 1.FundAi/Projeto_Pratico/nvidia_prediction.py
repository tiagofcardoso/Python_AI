...
data_path = os.path.join(os.path.dirname(
    __file__), './data_sets/HistoricalData_NVDA.csv')
...
forecast.to_csv(
    '/home/tiagocardoso/AIEngineer/1.FundAi/Projeto_Pratico/data_sets/forecast_nvidia.csv')
...
fig.update_layout(title='NVIDIA')
fig.show()

# Plot the forecast components using Plotly
fig_components = plot_components_plotly(model, forecast)
fig_components.update_layout(title='NVIDIA split')
fig_components.show()
